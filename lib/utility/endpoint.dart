...
class EndPoint {
  ...
  static final String GET_CALENDARI_AZIENDA = "test/getCalendariSettimane2.php";
  ...
  static final String INVIO_RICHIESTA_APPUNTAMENTO = "test/creaAppuntamento.php";

  // fornisce la lista delle prenotazioni, che fondamentalmente e' quella presente nell'interfaccia "Lista appuntamenti"
  static final String GET_LISTA_PRENOTAZIONI = "test/getAppuntamenti.php";
